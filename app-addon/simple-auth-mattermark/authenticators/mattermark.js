...
export default Base.extend({
  ...
  */
  serverTokenEndpoint: 'https://api.mattermark.com/authenticate',
  ...
  authenticate: function(credentials) {
    ...
    return new Ember.RSVP.Promise(function(resolve, reject) {
      ...
      data = {
        ...
        api_client_token: "rht4bF2LfHpRz4txLFMJ2e1XXk8D4duHw0jfxB2k7CPnEpfl2vrmtPU6nOvxK4dPojrHljGN3DKPtVBQE1cMIw=="
      };
